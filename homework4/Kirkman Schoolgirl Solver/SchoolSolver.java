...
public class SchoolSolver {
                        ...
                        while (currentDay.size() < NUM_ROWS) { // 5 rows
                                ...
                                while (currentRow.size() < NUM_GIRLS_IN_A_ROW) { // 3 girls to a row
                                        ...
                                        if (girlQueue.getFlag() == true) {
                                                ...
                                                // add the next girl in the queue.
                                                break;
                                        }
        ...
        /**
         * This private helper method returns whether or not r is a valid row
         *
         * @param r
         * @return
         */
        ...
        public static void addAdjacents(RowStack r, Schoolgirl girl) {
                ...
                // this logs the students walking next to each other
